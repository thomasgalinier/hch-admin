                            ...
                            <div className="pr-3 w-full justify-center items-center flex">
                                ...
                                <DropdownMenu>
                                    <DropdownMenuTrigger asChild>
                                        <Button variant='ghost' size='sm'><Plus size={15}/></Button>
                                    </DropdownMenuTrigger>
                                    <DropdownMenuContent>
                                        <DropdownMenuItem className="cursor-pointer">
                                            <Link href={"/comptes/admin/create"}>
                                                Ajouter un admin
                                            </Link>
                                        </DropdownMenuItem>
                                        <DropdownMenuItem className="cursor-pointer">Ajouter un
                                            technicien</DropdownMenuItem>
                                    </DropdownMenuContent>
                                </DropdownMenu>
                            </div>
                        ...
                        <TooltipTrigger asChild>
                            ...
                            >
                                <Link href="/dashboard">
                                    ...
                                    <p data-collapse={isCollapsed}
                                       className="text-xs data-[collapse=true]:hidden">Dashboard</p>
                                </Link>
                            </Button>
                        </TooltipTrigger>
                        {isCollapsed && (
                        ...
                        <TooltipTrigger asChild>
                            ...
                            >
                                <Link href="/comptes">
                                    ...
                                    <p data-collapse={isCollapsed}
                                       className="text-xs data-[collapse=true]:hidden">Comptes</p>
                                </Link>
                            </Button>
                        </TooltipTrigger>
                        {isCollapsed && (
